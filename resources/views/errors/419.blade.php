...
@section('seo_title', 'انتهت الجلسة | المكتبة الكاملة')
@section('seo_description', 'عذراً، انتهت صلاحية الجلسة، يرجى تحديث الصفحة.')
        ...
        <div class="space-y-8 max-w-lg mx-auto">
            ...
            <div class="space-y-4 relative -top-8">
                ...
                <p class="text-gray-600 text-lg leading-relaxed">
                    عذراً، انتهت صلاحية الجلسة بسبب عدم النشاط. يرجى تحديث الصفحة والمحاولة مرة أخرى.
                </p>
            </div>
