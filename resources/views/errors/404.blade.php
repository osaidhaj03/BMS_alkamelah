...
@section('seo_title', 'الصفحة غير موجودة | المكتبة الكاملة')
@section('seo_description', 'عذراً، الصفحة التي تبحث عنها غير موجودة.')
        ...
        <div class="space-y-8 max-w-lg mx-auto">
            ...
            <div class="space-y-4 relative -top-8">
                ...
                <p class="text-gray-600 text-lg leading-relaxed">
                    يبدو أن الصفحة التي تبحث عنها قد تم نقلها أو حذفها أو أن الرابط الذي استخدمته غير صحيح.
                </p>
            </div>
