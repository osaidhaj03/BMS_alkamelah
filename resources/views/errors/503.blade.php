...
@section('seo_title', 'الموقع تحت الصيانة | المكتبة الكاملة')
@section('seo_description', 'عذراً، الموقع تحت الصيانة حالياً. سنعود قريباً.')
        ...
        <div class="space-y-8 max-w-lg mx-auto">
            ...
            <div class="space-y-4 relative -top-8">
                ...
                <p class="text-gray-600 text-lg leading-relaxed">
                    عذراً، نقوم حالياً ببعض أعمال الصيانة الدورية. سنعود للعمل قريباً جداً. شكراً لصبركم.
                </p>
            </div>
