...
@section('seo_title', 'انتهت مهلة البوابة | المكتبة الكاملة')
@section('seo_description', 'عذراً، لم يتلق الخادم استجابة في الوقت المناسب.')
        ...
        <div class="space-y-8 max-w-lg mx-auto">
            ...
            <div class="space-y-4 relative -top-8">
                ...
                <p class="text-gray-600 text-lg leading-relaxed">
                    عذراً، استغرق الخادم وقتاً طويلاً للاستجابة. يرجى المحاولة مرة أخرى لاحقاً.
                </p>
            </div>
