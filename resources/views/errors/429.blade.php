...
@section('seo_title', 'طلبات كثيرة جداً | المكتبة الكاملة')
@section('seo_description', 'عذراً، لقد قمت بإرسال طلبات كثيرة جداً في وقت قصير.')
        ...
        <div class="space-y-8 max-w-lg mx-auto">
            ...
            <div class="space-y-4 relative -top-8">
                ...
                <p class="text-gray-600 text-lg leading-relaxed">
                    عذراً، لقد قمت بإرسال عدد كبير من الطلبات في وقت قصير. يرجى الانتظار بضع لحظات قبل المحاولة مرة أخرى.
                </p>
            </div>
