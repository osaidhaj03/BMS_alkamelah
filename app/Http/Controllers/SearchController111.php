...
class SearchController extends Controller
{
    ...
    /**
     * Health check for Elasticsearch search service
     *
     * @param UltraFastSearchService $searchService
     * @return \Illuminate\Http\JsonResponse
     */
    public function healthCheck(UltraFastSearchService $searchService)
    {
        try {
            ...
            return response()->json([
                ...
                'elasticsearch' => $health['elasticsearch'] ?? 'unknown',
                'timestamp' => now()->toISOString(),
                'server' => config('services.elasticsearch.host'),
